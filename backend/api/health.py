...
@health_router.get("/api/health", status_code=status.HTTP_200_OK, include_in_schema=False)
...
@health_router.get("/api/health/live", status_code=status.HTTP_200_OK)
...
@health_router.get("/api/health/ready", status_code=status.HTTP_200_OK)
...
@health_router.get("/health/startup", status_code=status.HTTP_200_OK)
@health_router.get("/api/health/startup", status_code=status.HTTP_200_OK)
...
@health_router.get("/api/health/detailed", status_code=status.HTTP_200_OK)
