...
try:
    ...
    class FallbackSettings:
        def __init__(self):
            ...
            self.RATE_LIMIT_AUTH_WINDOW_SECONDS = int(
                os.getenv("RATE_LIMIT_AUTH_WINDOW_SECONDS", 900)
            )
            self.RATE_LIMIT_AUTH_IP_MAX_ATTEMPTS = int(
                os.getenv("RATE_LIMIT_AUTH_IP_MAX_ATTEMPTS", 20)
            )
            self.RATE_LIMIT_AUTH_IP_WINDOW_SECONDS = int(
                os.getenv("RATE_LIMIT_AUTH_IP_WINDOW_SECONDS", 300)
            )
