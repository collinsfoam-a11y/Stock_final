...
class AutoRecovery:
    ...
    def _handle_default(self, default_value: Any) -> tuple[Any, bool, str | None]:
    ...
    async def _handle_fallback_async(self, fallback: Callable) -> tuple[Any, bool, str | None]:
