...
class AutoDiagnosisService:
    ...
    async def diagnose_error(
        self, error: Exception, context: dict[str, Any | None] | None = None
    ) -> DiagnosisResult:
        """
    ...
    def _classify_error(self, error: Exception) -> tuple[ErrorCategory, ErrorSeverity]:
        ...
        # Check patterns
        for pattern_data in self._error_patterns.values():
    ...
    async def auto_fix_error(
        self, diagnosis: DiagnosisResult, context: dict[str, Any | None] | None = None
    ) -> Result[Any, Exception]:
