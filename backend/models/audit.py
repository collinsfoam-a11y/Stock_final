...
class AuditEventType(str, Enum):
    ...
    INVENTORY_IDENTITY_UPSERTED = "INVENTORY_IDENTITY_UPSERTED"
    PHYSICAL_BATCH_CHANGED = "PHYSICAL_BATCH_CHANGED"
    CANONICAL_SERIAL_CHANGED = "CANONICAL_SERIAL_CHANGED"
    DAMAGE_CASE_CHANGED = "DAMAGE_CASE_CHANGED"
