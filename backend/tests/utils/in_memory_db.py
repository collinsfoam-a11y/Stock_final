...
class InMemoryDatabase:
    ...
    def __init__(self):
        ...
        self.event_sequences = InMemoryCollection()
        self.event_applied = InMemoryCollection()
        self.projection_operations_log = InMemoryCollection()
        self.projection_replay_checkpoints = InMemoryCollection()
        self.projection_rebuild_leases = InMemoryCollection()
        self.projection_rebuild_fencing_tokens = InMemoryCollection()
        self.replay_certification_reports = InMemoryCollection()
        self.websocket_replay_log = InMemoryCollection()
        self.websocket_replay_sequences = InMemoryCollection()
        self.websocket_replay_cursors = InMemoryCollection()
        self.websocket_socket_ownership = InMemoryCollection()
        self.websocket_socket_ownership_sequences = InMemoryCollection()
        self.websocket_replay_worker_leases = InMemoryCollection()
        ...
        self.erp_snapshot_history = InMemoryCollection()
        ...
        self.governance_ledger = InMemoryCollection()
