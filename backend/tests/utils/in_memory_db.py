...
class InMemoryCollection:
    ...
    async def update_one(
        ...
        update: dict[str, Any],
        upsert: bool = False,
        array_filters: list[dict] | None = None,  # Added array_filters to signature to match generic usage
        *args,
        **kwargs,
    ) -> UpdateResult:
    ...
    async def count_documents(
        self,
        filter_query: dict[str, Any | None] | None = None,
        *args,
        **kwargs,
    ) -> int:
    ...
    def find(
        self,
        filter_query: dict[str, Any | None] | None = None,
        projection: dict[str, int | None] | None = None,
        *args,
        **kwargs,
    ):
        results = []
...
def _setup_mock_services(monkeypatch, server_module) -> None:
    ...
    monkeypatch.setattr(lifespan_module, "AutoSyncManager", MagicMock(return_value=mock_auto_sync))
