...
class TestSessionModels:
    ...
    def test_session_create_model_accepts_location_metadata(self):
        session_create = SessionCreate(
            ...
            location_path_ids=["warehouse-1", "location-1"],
            location_path_names=["Main Warehouse", "Ground Floor"],
        )
        ...
        assert session_create.location_id == "location-1"
        assert session_create.location_path_ids == ["warehouse-1", "location-1"]
