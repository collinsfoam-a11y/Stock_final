...
INDEXES: dict[str, list[tuple[list[tuple[str, Union[int, str]]], dict]]] = {
    ...
    "manual_items": [
        ([("item_code", 1)], {"unique": True, "name": "idx_manual_items_item_code"}),
        ([("barcode", 1)], {"name": "idx_manual_items_barcode", "sparse": True}),
        ([("created_at", -1)], {"name": "idx_manual_items_created_at"}),
        ([("created_by", 1), ("created_at", -1)], {"name": "idx_manual_items_created_by"}),
    ],
