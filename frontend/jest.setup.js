...
// Mock @sentry/react-native to avoid ESM transform issues in Jest
jest.mock("@sentry/react-native", () => ({
  ...
  lastEventId: jest.fn(),
  getReactNativeNativeStackIntegration: jest.fn(),
  getDefaultCurrentScope: jest.fn(),
  getDefaultGlobalScope: jest.fn(),
  getDefaultIsolationScope: jest.fn(),
  init: jest.fn(),
  close: jest.fn(),
  flush: jest.fn(),
