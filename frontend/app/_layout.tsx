...
import { supportsNativeAnimationDriver } from "../src/utils/animation";
import * as SplashScreen from "expo-splash-screen";
import { useFonts } from "expo-font";
// Initialize Sentry for remote crash reporting before any app code runs.
// The DSN is injected via EXPO_PUBLIC_SENTRY_DSN (empty/missing disables Sentry).
...
// Initialize Sentry for remote crash reporting before the app renders.
// DSN comes from EXPO_PUBLIC_SENTRY_DSN; empty/missing disables Sentry
// (safe for local dev). beforeSend strips sensitive URL data from breadcrumbs.
Sentry.init({
...
function RootLayout() {
  ...
  return (
    <View style={styles.root}>
      {appShellWithDeps}
      <Animated.View style={[styles.bootOverlay, { opacity: bootOpacity, pointerEvents: "none" as any }]}>
        <BootLoadingView
          initError={null}
