...
const styles = StyleSheet.create({
  ...
  loadingText: {},
  recommendationsCard: {
    marginBottom: DASHBOARD_SPACE.xl,
    padding: DASHBOARD_SPACE.lg,
  },
  recommendationsHeader: {
    flexDirection: "row",
    alignItems: "center",
    gap: DASHBOARD_SPACE.sm,
    marginBottom: DASHBOARD_SPACE.md,
  },
  ...
  recommendationAction: {
    ...
    alignItems: "center",
    gap: DASHBOARD_SPACE.sm,
    paddingHorizontal: DASHBOARD_SPACE.md,
    paddingVertical: DASHBOARD_SPACE.sm,
    borderRadius: DASHBOARD_RADIUS.lg,
    borderWidth: 1,
  },
  recommendationIcon: {
    width: 28,
    height: 28,
    borderRadius: DASHBOARD_RADIUS.full,
    alignItems: "center",
    justifyContent: "center",
  },
  recommendationCopy: {
