...
export default function LoginScreen() {
  ...
  const panelEntry = prefersReducedMotion
    ? undefined
    : FadeInDown.duration(uiTokens.motion.slow).springify();
      ...
      >
        ...
        >
          <View style={styles.contentContainer}>
            {/* Welcome Section */}
            <SafeAnimatedView entering={panelEntry} style={styles.welcomeSection}>
            ...
            {/* Login Form Card */}
            <SafeAnimatedView entering={panelEntry} style={styles.formContainer}>
              <ModernCard style={styles.loginCard} padding={unifiedSpacing.lg}>
                ...
                <View style={styles.modeToggle}>
                  <TouchableOpacity
                    ...
                    accessibilityHint="Switches to PIN sign in when a PIN is available"
                  ...
                  <TouchableOpacity
                    ...
                    accessibilityLabel="Credentials login"
                ...
                {loginMode === "pin" && (
                  <>
                    ...
                    <TouchableOpacity
                      ...
                      accessibilityHint="Focuses the PIN input"
                      hitSlop={TOUCH_HIT_SLOP}
                    >
                      {[0, 1, 2, 3].map((index) => (
                        <SafeAnimatedView
                          ...
                          entering={
                            prefersReducedMotion
                              ? undefined
                              : FadeInDown.delay(
                                  index * Math.floor(uiTokens.motion.fast / 3)
                                ).duration(uiTokens.motion.normal)
                          }
                          style={[
                            styles.pinDot,
                    ...
                    <View style={styles.pinActions}>
                      {biometricAuthEnabled && lastLoggedUser?.has_pin ? (
                        <TouchableOpacity
                          ...
                          accessibilityHint="Starts biometric sign in"
                          hitSlop={TOUCH_HIT_SLOP}
                        >
                          <Ionicons
                            name="finger-print"
                      ...
                      <View style={styles.pinBottomActions}>
                        <TouchableOpacity
                          ...
                          accessibilityHint="Shows PIN reset guidance"
                          hitSlop={TOUCH_HIT_SLOP}
                        >
            ...
            <Animated.View
              entering={
                prefersReducedMotion
                  ? undefined
                  : FadeInDown.delay(uiTokens.motion.fast)
                      .duration(uiTokens.motion.slow)
                      .springify()
              }
              style={styles.footer}
            >
