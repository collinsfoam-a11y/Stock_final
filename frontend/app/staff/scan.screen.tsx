    ...
    >
        ...
        rightComponent={
          <View style={styles.headerActions}>
            <TouchableOpacity
              ...
              accessibilityHint="Ends the current signed-in session"
      ...
      >
        <ModernButton
          ...
          fullWidth
          accessibilityHint="Opens the finish rack confirmation"
        />
      </View>
          ...
          style={[
            ...
            styles.pointerEventsNone,
            {
              backgroundColor: colorWithAlpha(
                uiTokens.mode === "dark" ? uiTokens.colors.background : uiTokens.colors.surface,
      ...
      {showPerformanceOverlay && (
        <View
          style={[
            ...
            {
              backgroundColor: colorWithAlpha(
                performanceWarning ? uiTokens.colors.error : uiTokens.colors.success,
                0.84
              ),
            },
          ]}
