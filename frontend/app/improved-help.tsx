/**
 * Improved Help Screen - App documentation and help
...
import { StandardizedErrorCard } from "@/components/ui/StandardizedErrorCard";
...
export default function ImprovedHelpScreen() {
    ...
    <View style={[styles.container, { backgroundColor: uiTokens.colors.background }]}>
      ...
      {error && (
        <StandardizedErrorCard
          title="Help Content Loading Failed"
          description={error}
      ...
      >
        ...
        <ModernCard
          padding={16}
          style={[styles.searchCard, { backgroundColor: uiTokens.colors.surfaceElevated }]}
        >
          <View style={styles.searchContainer}>
            <Ionicons name="search" size={20} color={uiTokens.colors.textSecondary} style={styles.searchIcon} />
            <TextInput
              style={[styles.searchInput, { color: uiTokens.colors.textPrimary }]}
            ...
            {searchQuery.length > 0 && (
              <AppTouchable onPress={() => setSearchQuery("")} style={styles.clearButton}>
        ...
        >
          ...
          <AppTouchable
            ...
            onPress={() => {
              // In a real app, this would open email, chat, or ticket system
              setError("Contact method not implemented in demo. Please reach out to your IT department.");
            }}
          >
            <Text style={[styles.supportButtonText, { color: uiTokens.colors.surface }]}>
              Contact Support
            </Text>
          </AppTouchable>
        </ModernCard>
