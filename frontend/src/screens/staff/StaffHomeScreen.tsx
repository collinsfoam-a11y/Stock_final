...
const StaffHome = React.memo(function StaffHome() {
  ...
  const renderSessionCard = (
    ...
    return (
      <ModernCard
        ...
        accessibilityLabel={`${isOpenStatus ? "Resume" : "Open history for"} ${session.warehouse}. ${getScannedCount(session)} scanned, ${issueCount} issues.`}
        accessibilityHint={
          isOpenStatus
            ? "Opens this active session for scanning"
            : "Opens the count history for this session"
        }
      >
  ...
  const renderContent = () => {
    if (activeTab === "active") {
      return (
        <Animated.View
          entering={prefersReducedMotion ? undefined : FadeInDown.duration(uiTokens.motion.normal)}
        >
          <ModernButton
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        <TouchableOpacity
          ...
          accessibilityHint="Shows sessions that can be resumed"
          hitSlop={TOUCH_HIT_SLOP}
        >
        ...
        <TouchableOpacity
          ...
          accessibilityHint="Shows completed and submitted sessions"
          hitSlop={TOUCH_HIT_SLOP}
        >
        ...
        >
          <View style={styles.modalHeader}>
            ...
            <TouchableOpacity
              ...
              accessibilityHint="Closes without starting a session"
              hitSlop={TOUCH_HIT_SLOP}
            >
          ...
          >
            ...
            {locationType && (
              <Animated.View
                entering={
                  prefersReducedMotion ? undefined : FadeInUp.duration(uiTokens.motion.normal)
                }
              >
