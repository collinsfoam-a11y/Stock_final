  ...
  return (
    <View style={styles.section}>
      ...
      <View style={[styles.list, styles.listContent]}>
        {/* ⚡ Bolt: Replaced FlatList with standard View mapping since scrollEnabled=false.
            This avoids virtualization overhead for non-scrolling lists inside scrollable parents. */}
