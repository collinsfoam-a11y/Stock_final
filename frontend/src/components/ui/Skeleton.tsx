...
export const SkeletonCard: React.FC<{ style?: ViewStyle; accessibilityLabel?: string }> = ({
  style,
  accessibilityLabel = "Loading...",
}) => {
  return (
...
// List item skeleton
export const SkeletonListItem: React.FC<{ style?: ViewStyle; accessibilityLabel?: string }> = ({
  style,
  accessibilityLabel = "Loading...",
}) => {
  return (
