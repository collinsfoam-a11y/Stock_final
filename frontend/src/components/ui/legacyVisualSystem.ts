...
export const legacyVisualSystemRegistry = {
  ...
  PremiumButton: {
    classification: "wrapper-only",
    replacement: "ModernButton",
    guidance: "Use ModernButton for new work. PremiumButton is a compatibility adapter.",
  },
  PremiumCard: {
    classification: "wrapper-only",
    replacement: "ModernCard",
    guidance: "Use ModernCard for new work. PremiumCard is a compatibility adapter.",
  },
  PremiumInput: {
    classification: "wrapper-only",
    replacement: "ModernInput",
    guidance: "Use ModernInput for new work. PremiumInput is a compatibility adapter.",
  },
  GlassCard: {
  ...
  EnhancedButton: {
    classification: "wrapper-only",
    replacement: "ModernButton",
    guidance: "Use ModernButton for new work. EnhancedButton remains only for legacy compatibility.",
  },
  EnhancedInput: {
    classification: "wrapper-only",
    replacement: "ModernInput",
    guidance: "Use ModernInput for new work. EnhancedInput remains only for legacy compatibility.",
  },
  RippleButton: {
    classification: "wrapper-only",
    replacement: "ModernButton",
    guidance: "Use ModernButton for new work. RippleButton remains only for legacy compatibility.",
  },
  AuroraBackground: {
    classification: "approved-exception",
