...
export const DataTable: React.FC<DataTableProps> = ({
  ...
  // Since the table content should not scroll vertically independently, we replace FlashList
  // with a standard map to avoid unnecessary virtualization overhead.
  return (
