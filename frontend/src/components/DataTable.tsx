      ...
      <View style={styles.tableWrapper}>
        ...
        >
          <View style={styles.tableContent}>
            {/* ⚡ Bolt: Replaced FlashList with standard map since scrollEnabled={false}, removing virtualization overhead for bounded lists */}
            {paginatedData.map((item, index) => {
              // Create a stable key from item data just in case item identity changes but content doesn't
