      ...
      <View style={styles.tableContainer}>
        ...
        >
          <View style={{ width: tableWidth }}>
            ...
            {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList) to improve scrolling performance, handle potentially long dashboards without lag, and reduce frame drops. Removed legacy FlatList performance props. */}
            <VirtualList
              data={data}
