      ...
      <View style={styles.tableContainer}>
        ...
        >
          <View style={{ width: tableWidth }}>
            ...
            {/* ⚡ Bolt: Replaced FlatList with VirtualList (FlashList) to improve scrolling performance, handle potentially long paginated realtime dashboard lists without lag, and reduce frame drops. */}
            <VirtualList
              data={data}
